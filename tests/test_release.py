...
class TestMain:
    ...
    @patch('subprocess.run')
    def test_main_success(self, mock_subprocess, mock_branch, mock_package, 
                         mock_update_citation, mock_run_command):
...
'''
            ...
            try:
                ...
                with patch('pycoupler.release.run_command') as mock_run_command, \
